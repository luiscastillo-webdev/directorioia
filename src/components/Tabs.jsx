...
import { GrWorkshop,GrVideo,GrTty,GrNote,GrImage,GrSwim } from "react-icons/gr";
  ...
  return (
    ...
    <div className="border-b border-gray-200 dark:border-gray-700 mt-[60px]">
        <ul className="flex flex-wrap -mb-px text-base font-medium text-center text-gray-500 dark:text-gray-400">
          <TabNavItem titulo='Todas' id='todas' icono={<GrTty size={28}/>} tabActive={tabActive} setTabActive={setTabActive}/>
          <TabNavItem titulo='Contenido' id='contenido' icono={<GrNote size={28}/>} tabActive={tabActive} setTabActive={setTabActive}/>
          <TabNavItem titulo='Audio / Video' id='video' icono={<GrVideo size={28}/>} tabActive={tabActive} setTabActive={setTabActive}/>
          <TabNavItem titulo='Imagen' id='imagen' icono={<GrImage size={28}/>} tabActive={tabActive} setTabActive={setTabActive}/>
          <TabNavItem titulo='Productividad' id='productividad' icono={<GrWorkshop size={28}/>} tabActive={tabActive} setTabActive={setTabActive}/>
          <TabNavItem titulo='Estilo/Vida' id='estilo' icono={<GrSwim size={28}/>} tabActive={tabActive} setTabActive={setTabActive}/>
        </ul>    
    </div>
