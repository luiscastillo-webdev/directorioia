...
const Cookies = () => {
  return (
    <div className="relative flex flex-col max-w-screen-xl mx-auto justify-center bg-white px-28 py-10">
      <h3>POLÍTICA DE COOKIES</h3>
      <p>
        Gran Directorio Apps Ia informa acerca del uso de las cookies en su
        página web:
      </p>
      ...
      <p>
        ...
        Entre otros, permiten a una página web almacenar y recuperar información
      ...
      <p>
        Según quien sea la entidad que gestione el dominio desde donde se envían
        las cookies y trate los datos que se obtengan se pueden distinguir dos
        tipos:
      </p>
      <p>
      ...
      <p>
        ...
        solicitado por el usuario en una sola ocasión (p.e. una lista de
      ...
      <p>
        Por último, existe otra clasificación según la finalidad para la que se
      ...
      <p>
        ...
        hacerse desde el menú Herramientas u Opciones.
      </p>
      <p>
      ...
      <ul className="list-disc">
        <li>
          ...
          es/windows-vista/Block-or-allow-cookies
        </li>
        <li>
          Mozilla Firefox:
          http://support.mozilla.org/es/kb/impedir-que-los-sitios-web-
          guarden-sus-preferencia
        </li>
        <li>Chrome: https://support.google.com/accounts/answer/61416?hl=es</li>
        <li>
          Safari:
          http://safari.helpmax.net/es/privacidad-y-seguridad/como-gestionar-las-
          cookies/
        </li>
        <li>Opera: http://help.opera.com/Linux/10.60/es-ES/cookies.html</li>
      </ul>
      <p>Declaración de cookies utilizadas en Gran Directorio APPS IA </p>
      ...
      <p>
        {" "}
        Gran Directorio APPS IA asume que usted acepta el uso de cookies. No
        obstante, muestra información sobre su Política de cookies en la parte
        inferior o superior de cualquier página del portal con cada inicio de
      ...
      <ul className="list-disc">
        ...
        <li>
          Aceptar cookies. No se volverá a visualizar este aviso al acceder a
          cualquier página del portal durante la presente sesión.
        </li>
        <li>
          Modificar su configuración. Podrá obtener más información sobre qué
          son las cookies, conocer la Política de cookies de Gran Directorio
          APPS IA y modificar la configuración de su navegador.
        </li>
      </ul>
    </div>
  );
